...
def SaveFile(file,path='',fileName=''):
	...
	filePath= os.path.join(BASE_DIR, 'blog/static')
	...
	print 'os.path.join(filePath, fileName)', os.path.join(filePath, fileName)
	fd=open(os.path.join(filePath, fileName),'wb')
